...
To make the DeskBuddy you will need:
Any Esp32 modules that have an antenna,a normal button,a touch button,a 0'96 inch oled screen
...
It has 6 functions:
1) Check the weather
2) Wifi test in percentile and RSSI (dBm)
3) Timer of up 24 hours
4) Dino game
5) Heads or tails
6) Petting the DeskBuddy



For the code
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/8c3c74bd-8f63-4bb7-8875-f001f3ba30ad" />
When you get to Wifi credentials put your SSID where it says "put your SSID" put the entire name,if theres "-" or other commas put them
